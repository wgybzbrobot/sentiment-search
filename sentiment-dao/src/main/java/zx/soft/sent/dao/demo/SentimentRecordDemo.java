...
public class SentimentRecordDemo {
	...
	public static void main(String[] args) {
		...
		// 获取Record数据，根据md5的id
		System.out.println(sr.selectRecordById("sent_records_0", "123456789").getUsername());
		// 获取Records数据，根据lasttime
		System.out.println(sr.selectRecordsByLasttime("sent_records_0", 985647200L, 985647213L).size());
		System.out.println(sr.selectRecordsByLasttime("sent_records_0", 985647200L, 985647212L).size());
		// 删除Record数据，根据md5的id
