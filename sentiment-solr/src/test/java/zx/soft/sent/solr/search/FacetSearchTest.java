...
public class FacetSearchTest {
	...
	public void testGetURL() {
		...
		assertEquals(
				"http://192.168.32.11:8983/solr/sentiment/select?wt=json&indent=true&facet=true&rows=0&q=*:*&facet.date"
						+ "=timestamp&facet.date.start=NOW-7DAYS&facet.date.end=NOW&facet.date.gap=%2B1DAY",
