package zx.soft.spider.solr.domain;
...
public class Reply {
	...
	private final long HFID; //回复ID
	private final long HFFID; //回复父ID
	...
	public static class Builder {
		...
		private long HFID; //回复ID
		private long HFFID; //回复父ID
		...
		public Builder(long hFID, String uRL) {
			HFID = hFID;
			URL = uRL;
		}

		public Builder setHFID(long hFID) {
			HFID = hFID;
			return this;
		}

		public Builder setHFFID(long hFFID) {
			HFFID = hFFID;
			return this;
		}
